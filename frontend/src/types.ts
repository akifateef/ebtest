...
export const GENERAL_QUESTION_POOL_SIZE = 300;
export const STATE_QUESTION_POOL_SIZE = 10;
export const QUESTION_POOL_SIZE =
  GENERAL_QUESTION_POOL_SIZE + STATE_QUESTION_POOL_SIZE;
